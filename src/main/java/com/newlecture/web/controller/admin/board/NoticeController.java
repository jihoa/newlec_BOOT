...
public class NoticeController {
	...
	public String list(Model model, 
		...
		List<NoticeView> list = service.getPubViewList(page, field, query);
	...
	public String list(HttpServletRequest request, 
		...
		switch(cmd) {
			...
			case "일괄공개":
				...
				//전부
				int allresult = service.updatePubAll(openids1, closeids1);
			break;		
	...
	public String detail(Model model, int id) {
		...
		List<NoticeView> list = service.getPubViewListDetail(id);
	...
	@PostMapping("reg")
	//@ResponseBody
	public String reg(String title, String content, String open, MultipartFile[] files, String category, String[] foods) throws IllegalStateException, IOException {
